                            ...
                            <div class="col-xl-12 col-md-12 replyInfo">
                                <div class="card bg-light mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                      	  <span>작성된 상품 <a class=" stretched-link" href="/shop/view?n=${goodsReply.goodsNumber}"> 바로가기</a></span>
                                        <div><svg class="svg-inline--fa fa-angle-right fa-w-8" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512" data-fa-i2svg=""><path fill="currentColor" d="M224.3 273l-136 136c-9.4 9.4-24.6 9.4-33.9 0l-22.6-22.6c-9.4-9.4-9.4-24.6 0-33.9l96.4-96.4-96.4-96.4c-9.4-9.4-9.4-24.6 0-33.9L54.3 103c9.4-9.4 24.6-9.4 33.9 0l136 136c9.5 9.4 9.5 24.6.1 34z"></path></svg><!-- <i class="fas fa-angle-right"></i> --></div>
                                    </div>
                                ...
                                <div class="replyDelete float-right mb-4">
										<form role="form" method="post">
											...
											<button type="submit" class="delete_${goodsReply.goodsReplyNumber}_btn btn btn-primary">삭제</button>
										</form>
