...
<body>
	...
	<div class="py-5 text-white h-25"
		style="background-image: linear-gradient(rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.75)), url(&quot;https://static.pingendo.com/cover-bubble-dark.svg&quot;); background-position: center center, center center; background-size: cover, cover; background-repeat: repeat, repeat;">
																		...
																		<div class="row">
																			<div class="mx-auto col-md-10">
																				...
																				<c:url value="/member/withdrawal"
																					var="withdrawalUrl" />
																				<form:form class="text-left border p-4 bg-light"
																							...
																							<div class="row text-center">
																								<div class="col-md-6">
																									<button type="button"
																										...
																										id="withdrawalCancel" onclick="mypage()">취소하기</button>
																								</div>
																								<div class="col-md-6">
																									<button type="submit"
																										class="btn btn-lg btn-outline-primary btn-block"
